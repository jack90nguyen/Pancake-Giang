...
namespace Onetez.Web.Controllers
{
  public class BaseController : Controller
  {
    ...
    public bool IsMobile = GetDisplay();

    public UserModel UserInfo = GetUserInfo();

    public ConfigsEntity ConfigInfo = GetConfigInfo();
    ...
    public static ConfigsEntity GetConfigInfo()
    {
      return DbConfig.Get(1);
    }


    public static bool GetDisplay()
    {
      //Kiểm tra xem trình duyệt hiện tại là mobile hay ko?
      string mobile_u = System.Web.HttpContext.Current.Request.ServerVariables["HTTP_USER_AGENT"];
      ...
      bool isMobile = (mobile_b.IsMatch(mobile_u) || mobile_v.IsMatch(mobile_u.Substring(0, 4))) ? true : false;
